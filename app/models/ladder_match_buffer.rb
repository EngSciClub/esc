class LadderMatchBuffer < ActiveRecord::Base
	validates :player1,
	...
	def check_if_buffer_exists
			#TO-DO(barryklfung) - check that buffer does not already exist. If it does, then migrate entry to 
	end
end
