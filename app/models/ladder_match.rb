# Public: Classes used to model matches between LadderUser classes.
# All instance methods are validations and should not be called outside of creation/saving
# 
# Examples
#   LadderMatch.point_calculate(elo1, elo2)
...
class LadderMatch < ActiveRecord::Base
  ...
  validates :player2,
            presence: true
  validates :winner, 
            inclusion: { in: [ 1 , 2 ], message: "Choose a winner."}
